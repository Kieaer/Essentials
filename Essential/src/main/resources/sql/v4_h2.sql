...
UPDATE plugin_data SET "data" = REPLACE("data", '"warpZones"', '"warpZone"');
UPDATE plugin_data SET "data" = REPLACE("data", '"warpCounts"', '"warpCount"');
UPDATE plugin_data SET "data" = REPLACE("data", '"warpTotals"', '"warpTotal"');
UPDATE plugin_data SET "data" = REPLACE("data", '"warpBlocks"', '"warpBlock"');
UPDATE plugin_data SET "data" = REPLACE("data", '"blacklist"', '"blacklistedNames"');
