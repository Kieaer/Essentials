...
public class Server implements Runnable {
    ...
    public class Service extends Thread {
        ...
        private String rankingdata(boolean lang) {
            ...
            StringBuilder joincount = new StringBuilder();
            StringBuilder kickcount = new StringBuilder();
            StringBuilder expcount = new StringBuilder();
            StringBuilder playtime = new StringBuilder();
            StringBuilder pvpcount = new StringBuilder();
            StringBuilder reactorcount = new StringBuilder();
            ...
            if (lang) {
                return "<!DOCTYPE html>\n" +
                        ...
                        "#info_body{width: 100%;height: 400px;background-color: white;padding: 5px;}\n" +
                        "</style>\n" +
                        jquery + cookie +
                        "<script>\n" +
                        "$(function(){\n" +
                        ...
                        "</div>\n" +
                        "<div class=\"rankbox\">\n" +
                        "<span>Server join time rank</span>\n" +
                        "<table>\n" +
                        "<tr>\n" +
                        "<th>Name</th>\n" +
                        "<th>Country</th>\n" +
                        ...
                        "</div>\n" +
                        "<div class=\"rankbox\">\n" +
                        "<span>Experience value rank</span>\n" +
                        "<table>\n" +
                        "<tr>\n" +
                        "<th>Name</th>\n" +
                        "<th>Country</th>\n" +
                        ...
                        "</div>\n" +
                        "<div class=\"rankbox\">\n" +
                        "<span>In-game playtime rank</span>\n" +
                        "<table>\n" +
                        "<tr>\n" +
                        "<th>Name</th>\n" +
                        "<th>Country</th>\n" +
                        ...
                        "</div>\n" +
                        "<div class=\"rankbox\">\n" +
                        "<span>Throium Reactor place count</span>\n" +
                        "<table>\n" +
                        "<tr>\n" +
                        "<th>Name</th>\n" +
                        "<th>Country</th>\n" +
                ...
                return "<!DOCTYPE html>\n" +
                        ...
                        "\n" +
                        "<div id=\"box\">\n" +
                        "<header>플레이어 순위</header>\n" +
                        "<nav>\n" +
                        "<ul>\n" +
                        "<li><a href=\"#\" id=\"serverinfo\">현재 서버 정보</a></li>\n" +
                        "</ul>\n" +
                        "</nav>\n" +
                        "<div id=\"body\">\n" +
                        "<div class=\"rankbox\">\n" +
                ...
                try {
                    ...
                    if (query) {
                        if (receive.matches("GET / HTTP/.*")) {
                            ...
                            String rankkr = rankingdata(false);
                            bw.write("HTTP/1.1 200 OK\r\n");
                            bw.write("Date: " + time + "\r\n");
                            bw.write("Server: Mindustry/Essentials 5.0\r\n");
                            bw.write("Content-Type: text/html; charset=utf-8\r\n");
